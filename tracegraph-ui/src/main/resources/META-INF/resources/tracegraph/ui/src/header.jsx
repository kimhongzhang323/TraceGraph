...
const Header = ({ route, theme, setTheme }) => (
  <header className="sticky top-0 z-50 backdrop-blur-md bg-white/75 dark:bg-ink-950/75 border-b hairline">
    <div className="max-w-[1500px] mx-auto px-6 lg:px-8 h-14 flex items-center gap-6">
      ...
      <div className="hidden md:flex items-center gap-2 mono text-[12px] text-ink-500">
      ...
      <div className="flex items-center gap-2">
        ...
        <a href="#" className="w-8 h-8 rounded-md inline-flex items-center justify-center text-ink-600 dark:text-ink-400 hover:bg-ink-100 dark:hover:bg-ink-900" aria-label="GitHub">
          <Icon name="github" size={15} />
        </a>
        <Button size="sm" variant="primary" as="a" href="#/docs/quickstart" className="hidden sm:inline-flex">Quickstart</Button>
      </div>
    </div>
  </header>
);
